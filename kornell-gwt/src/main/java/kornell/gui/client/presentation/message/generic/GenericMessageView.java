...
public class GenericMessageView extends Composite implements MessageView,ValidationChangedHandler {
	...
	// TODO fix this
	private String IMAGE_PATH = "skins/first/icons/message/";
	...
	@UiField Form form;
	@UiField FlowPanel messageFields;
	...
	public GenericMessageView(ClientFactory clientFactory) {
	...
	private void initData() {
		...
		isCurrentUser = session.getCurrentUser().getPerson().getUUID().equals(((MessagePlace) placeCtrl.getWhere()).getViewType());
		...
		final String messageUserUUID = ((MessagePlace) placeCtrl.getWhere()).getViewType();
	...
	private void display() {
		...
		messageFields.add(formHelper.getImageSeparator());
	...
	/*private FormPanel getPictureUploadFormPanel() {
		...
		fileUploadWrapper.add(new Image(IMAGE_PATH + "messagePic.png"));   
	...
	private void displayContactDetails() {
		...
		messageFields.add(addressLine1);
		...
		messageFields.add(addressLine2);
		...
		messageFields.add(postalCode);
	}

	@Override
	public void setPresenter(Presenter p) {
		presenter = p;
		GWT.log(presenter.getViewType());
