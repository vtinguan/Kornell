...
public class EnrollmentsClient extends RESTClient {
	...
	public void getEnrollmentsByCourseClass(String courseClassUUID, String ps, String pn, Callback<EnrollmentsTO> cb) {
		GET("/enrollments/?courseClassUUID=" + courseClassUUID + "&ps=" + ps + "&pn=" + pn).sendRequest(null, cb);
	}
