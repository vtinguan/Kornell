...
NRELIC_BIN_URL=s3://dist-us-east-1.craftware.com/NewRelic/newrelic.jar
...
JDBC_URL=s3://dist-us-east-1.craftware.com/MySQL/mysql-connector-java.jar
...
CFG_URL=s3://dist-us-east-1.craftware.com/WildFly/standalone-kornell-api.xml
...
KNL_API_URL=s3://dist-us-east-1.craftware.com/Kornell/kornell-api.war
