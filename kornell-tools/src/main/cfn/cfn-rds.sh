...
ARG_JDBC_PASSWORD="ParameterKey=knldbpassword,ParameterValue='$JDBC_PASSWORD'"

CFN_CREATE_ARGS="--parameters $ARG_VPC_DB_SUBNETS $ARG_VPC_DB_SECGS $ARG_DB_PUB $ARG_JDBC_PASSWORD"
